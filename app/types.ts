...
export interface Story { id: string; title: string; titleEn: string; tier: number; kind: KindKey; region: RegionKey; description: Bi; source: string; sourceUrl?: string; license: LicenseKey; accent?: string; pattern: StoryPattern; sentences: Sentence[]; interactive?: "alphabet" | "toneMatch"; }
